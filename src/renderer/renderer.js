...
const libraryScreen = window.KimbleLibraryScreen.create({
  ...
  dom: {
    ...
    forYouDiscoveryRefreshBtn: document.getElementById("forYouDiscoveryRefreshBtn"),
    forYouDiscoverySummary: document.getElementById("forYouDiscoverySummary"),
    forYouDiscoveryMetrics: document.getElementById("forYouDiscoveryMetrics"),
    forYouDiscoveryList: document.getElementById("forYouDiscoveryList"),
