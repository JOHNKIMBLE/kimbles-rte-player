...
contextBridge.exposeInMainWorld("rteDownloader", {
  ...
  createCollection: (input) => ipcRenderer.invoke("collections-create", typeof input === "string" ? { name: input } : (input || {})),
  updateCollection: (collectionId, patch = {}) => ipcRenderer.invoke("collections-update", { collectionId, patch }),
  ...
  refreshCollection: (collectionId, options = {}) => ipcRenderer.invoke("collections-refresh", { collectionId, options }),
  ...
  listHarvestDocs: (payload = {}) => ipcRenderer.invoke("metadata-harvest-docs-list", payload || {}),
  listMetadataRepairs: () => ipcRenderer.invoke("metadata-repairs-list"),
  addMetadataRepair: (payload = {}) => ipcRenderer.invoke("metadata-repairs-add", payload || {}),
  deleteMetadataRepair: (ruleId) => ipcRenderer.invoke("metadata-repairs-delete", { ruleId }),
